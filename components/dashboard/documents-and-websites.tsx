...
const AllDocumentsAndWebsites = (props: { store: IStore }) => {
...
const DocumentsAndWebsites = (props: { store: IStore }) => {
  const classes = panelStyles();

  return (
    <div className={classes.panel}>
      <AllDocumentsAndWebsites store={props.store} />
    </div>
  );
};

export default DocumentsAndWebsites;
