          ...
          <Grid item sm={7}>
            <Container maxWidth="sm">
              ...
              <div className={classes.section}>
                ...
                <Typography className={classes.body}>
                  Kelp does not store your passwords or personal data. We take security seriously
                  and apply experience from e-commerce, and healthcare data security. Kelp’s
              ...
              <div className={classes.section}>
                ...
                <Typography className={classes.body}>
                  During our public beta, Kelp is free to use. Eventually, we’ll add paid features
                  and integrations. The clear monetization guarantees that we are able to maintain
                  the tool for the long term.
                </Typography>
              </div>
              <Divider />
              <div className={classes.section}>
                ...
                <Typography className={classes.body}>
                  ...
                  years. I&rsquo;ve built tools for non-profits, art collectors, bike share
                  companies, e-commerce startups and for healthcare enterprise. Before being a
                  professional software engineer, I collaborated with{' '}
                  <MuiLink
                ...
                <Typography className={classes.body}>
                  ...
                  I&rsquo;ve lost documents, missed emails, created events with the missing
                  attendees and I&rsquo;ve had coworker relationships languish. While we are
                  responsible for our actions, humans are not well suited to dealing with the amount
                  of information and notifications we receive every day across an increasingly vast
                  set of sources.
                </Typography>
                <Typography className={classes.body}>
                  I hope to use my experience to build tools that help people take back their time
