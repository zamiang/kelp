        ...
        <Grid item sm={7}>
          <Container maxWidth="sm">
            ...
            <ul>
              ...
              <li>
                <Typography className={classes.body}>
                  <strong>Application Store</strong> means the digital distribution service operated
                  and developed by Apple Inc. (Apple App Store) or Google Inc. (Google Play Store)
            ...
            <Typography variant="h5">Subscription period</Typography>
            <Typography className={classes.body}>
              The Service or some parts of the Service are available only with a paid Subscription.
              You will be billed in advance on a recurring and periodic basis (such as daily,
              weekly, monthly or annually), depending on the type of Subscription plan you select
            ...
            <Typography variant="h5">Subscription cancellations</Typography>
            <Typography className={classes.body}>
              ...
              for Your current Subscription period and You will be able to access the Service until
            ...
            <Typography variant="h5">Fee Changes</Typography>
            <Typography className={classes.body}>
            ...
            <Typography className={classes.body}>
              ...
              not be charged by the Company until the Free trial has expired. On the last day of the
