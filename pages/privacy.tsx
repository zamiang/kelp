        ...
        <Box flex="0 0 58.33%">
          <Container maxWidth="sm">
            ...
            <Typography className={classes.body} id="c549f30c-5e94-4571-8959-45ac04d93553">
              ...
              are <em>only</em> used for logging in, password resets, responding to emails that you
              initiate, notifications that you request and notifying you about product updates or
              changes.
            </Typography>
            <Typography className={classes.body} id="d3ea54f1-2b64-4bb5-8ec6-258f2f92177d">
              ...
              protections to ensure Kelp only uses data that is necessary for the product, and that
            ...
            <Typography className={classes.body}>
              Kelp asks for the most restricted access that Google allows, which is read-only. Kelp
              cannot create new events, change any existing events, delete your calendar, or access
              any other data within your Google account, including Gmail.
            </Typography>
            <Typography className={classes.body}>
              Calendar data does not pass through Kelp. Your device requests the data directly from
              Google.
            </Typography>
            <Typography className={classes.body}>
            ...
            <Typography className={classes.body}>
              Kelp asks for the most restricted access that Google allows, which is read-only. Kelp
              cannot create new contacts, change any existing contacts, delete your contacts, or
            ...
            <Typography className={classes.body}>
              ...
              edit your contact notes from Kelp. Kelp does not edit any other contact related data.
            </Typography>
            <Typography className={classes.body}>
              Contacts data does not pass through Kelp. Your device requests the data directly from
              Google.
            </Typography>
            <Typography className={classes.body}>
            ...
            <Typography className={classes.body}>
              Kelp asks for the most restricted access that Google allows, which is read-only. Kelp
              cannot create new documents, change any existing documents, delete your documents, or
              access any other data within your Google account, including Gmail.
            </Typography>
            <Typography className={classes.body}>
              Documents data does not pass through Kelp. Your device requests the data directly from
              Google.
            </Typography>
            <Typography className={classes.body}>
            ...
            <Typography className={classes.body} id="6c786247-64ea-4614-9efd-dfae890576fe">
              If you enable notifications, we must store a token to send them. We <em>never</em> use
            ...
            <Typography className={classes.body} id="bc4e2c32-bc8f-4edb-950c-9fe93c52554f">
              Third parties may provide registration and authentication services. In this case, they
              will be able to access some data, stored by these third-party services, for
              registration or identification purposes. The services listed below may also collect
              Personal Data for targeting and profiling purposes; to find out more, please refer to
            ...
            <Typography className={classes.body} id="a8aa06a4-f296-4461-a4c4-82db4b328e6c">
              ...
              is connected to the Google network. Personal Data processed: various types of Data as
              specified in the privacy policy of the service.
            </Typography>
            <Typography className={classes.body}>
              Place of processing: United States –{' '}
              <MuiLink href="https://policies.google.com/privacy">Privacy Policy</MuiLink>. Privacy
              Shield participant.
            </Typography>
            <br />
            ...
            <Typography className={classes.body} id="c0ed4c51-ef08-4fd1-82d3-8f38095094ca">
              We may to contact you with product updates. You may opt-out of receiving any, or all,
              of these communications from Kelp by following the unsubscribe link or instructions
              provided in any email we send or by contacting us. We may use Email Marketing Service
            ...
            <Typography className={classes.body} id="e6c29dd6-3050-43b5-bb4e-394883f3b910">
              Contact information (i.e. an email address) is <em>only</em> accessible to a user who
              explicitly added that information, either via one of the above integrations or
              manually. This information isolation is reinforced with software safeguards to ensure
              contact information has appropriate visibility.
            </Typography>
            <br />
            ...
            <Typography className={classes.body} id="de721faa-d496-45af-80fa-4e4ce3ae727b">
              You’ll receive a reply from us to acknowledge that we received your report, and we’ll
              contact you if we need more information.
            </Typography>
            <Typography className={classes.body} id="042e72c2-3eb0-4a15-a597-ce571ac5ef43">
              For the protection of our members, Kelp doesn’t disclose, discuss, or confirm security
              issues until our investigation is complete and any necessary updates are generally
              available.
            </Typography>
            <br />
            ...
            <Typography className={classes.body} id="60849061-52e9-4e86-bed3-85020714d06f">
              If you have questions or concerns regarding these terms, privacy, or security, please
              contact us at{' '}
              <MuiLink href="mailto:support@kelp.nyc" target="_blank">
                support@kelp.nyc.
              </MuiLink>
