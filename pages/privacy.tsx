        ...
        <Grid container className={classes.info} justify="center">
          <Grid item sm={6}>
            ...
            <p id="c549f30c-5e94-4571-8959-45ac04d93553">
              When creating an account, you will be asked to Sign in with Auth0. Email addresses are{' '}
              <strong>only</strong> used for logging in, password resets, responding to emails that
            ...
            <p id="2b0333d9-d95c-4efe-aa47-3088e1548dce">
              Auth0 is a registration and authentication service provided by Auth0, Inc. To simplify
              the registration and authentication process, Auth0 can make use of third-party
              identity providers and save the information on its platform. Personal Data processed:
              Cookies; email address; first name; last name; password; picture; various types of
            ...
            <ul id="1baaa435-7ef2-4162-92c6-a5e87b5de52f">
              ...
              <li>
                A numbered list of steps required to reproduce the issue and a video demonstration,
            ...
            <p id="60849061-52e9-4e86-bed3-85020714d06f">
              ...
              contact us at <a href="mailto:support@kelp.nyc">support@kelp.nyc.</a>
            </p>
          </Grid>
        </Grid>
        <Footer />
