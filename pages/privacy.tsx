          ...
          <Grid item sm={7}>
            <Container>
              ...
              <Typography
                ...
                id="c549f30c-5e94-4571-8959-45ac04d93553"
              >
              ...
              <Typography
                variant="h6"
                className={classes.body}
                id="d3ea54f1-2b64-4bb5-8ec6-258f2f92177d"
              >
              ...
              <Typography
                variant="h6"
                className={classes.body}
                id="09b745da-affa-46ee-8292-d39436c1b33b"
              >
              ...
              <Typography
                variant="h6"
                className={classes.body}
                id="0d6975f5-495c-4755-8784-320b88e3955a"
              >
              ...
              <ul id="45abd295-c77e-421a-a8ec-26ed8c0f4cdb">
                ...
                <li>
                  <Typography variant="h6" className={classes.body}>
                    ...
                    to edit your contact notes from Kelp. Kelp does not edit any other contact
                    related data.
                  </Typography>
                </li>
                <li>
              ...
              <Typography
                variant="h6"
                className={classes.body}
                id="a3c5643a-84ff-492a-8d05-692d5c8c294e"
              >
              ...
              <Typography
                variant="h6"
                className={classes.body}
                id="6c786247-64ea-4614-9efd-dfae890576fe"
              >
              ...
              <Typography
                variant="h6"
                className={classes.body}
                id="195f56fa-033c-494c-8bd9-c325b309e456"
              >
              ...
              <Typography
                variant="h6"
                className={classes.body}
                id="8f45e739-b057-4e75-939c-d683894dd797"
              >
              ...
              <Typography
                variant="h6"
                className={classes.body}
                id="bc4e2c32-bc8f-4edb-950c-9fe93c52554f"
              >
              ...
              <Typography
                variant="h6"
                className={classes.body}
                id="a8aa06a4-f296-4461-a4c4-82db4b328e6c"
              >
              ...
              <Typography
                variant="h6"
                className={classes.body}
                id="c0ed4c51-ef08-4fd1-82d3-8f38095094ca"
              >
              ...
              <Typography
                variant="h6"
                className={classes.body}
                id="47fe45d0-c532-4a9b-9407-bce45855cd3f"
              >
              ...
              <Typography
                variant="h6"
                className={classes.body}
                id="ab868a21-4ef7-4821-86dc-c4441ff6d243"
              >
              ...
              <Typography
                variant="h6"
                className={classes.body}
                id="f4b8401e-30f6-4ba3-aba7-ed358b3ff0a3"
              >
              ...
              <Typography
                variant="h6"
                className={classes.body}
                id="d2250a4c-b192-4203-877a-2996e270c143"
              >
              ...
              <Typography
                variant="h6"
                className={classes.body}
                id="7f328583-f1a8-464e-8bb0-3b6e6670d547"
              >
              ...
              <Typography
                variant="h6"
                className={classes.body}
                id="9db05fda-9420-460f-b379-d4823e5a48af"
              >
              ...
              <Typography
                variant="h6"
                className={classes.body}
                id="abe6ab68-85ae-45b5-9d8d-af53fc51e150"
              >
              ...
              <Typography
                variant="h6"
                className={classes.body}
                id="8a00172b-1f81-4809-b6be-bbd1f974e784"
              >
              ...
              <Typography
                variant="h6"
                className={classes.body}
                id="e529f888-2741-4efd-bfcd-e5e914ba2b15"
              >
              ...
              <Typography
                variant="h6"
                className={classes.body}
                id="d7528e36-63e5-48b7-936c-6ab6f6fe689e"
              >
              ...
              <Typography
                variant="h6"
                className={classes.body}
                id="f5afc65e-d5d1-47be-a3dd-44ed47be109d"
              >
              ...
              <Typography
                variant="h6"
                className={classes.body}
                id="e6c29dd6-3050-43b5-bb4e-394883f3b910"
              >
              ...
              <Typography
                variant="h6"
                className={classes.body}
                id="9b935272-c9b1-4a9d-9567-064135514702"
              >
              ...
              <Typography
                variant="h6"
                className={classes.body}
                id="e7f2691f-4747-4daf-9daf-ad397de219ef"
              >
                You can report a security or privacy vulnerability by emailing us at{' '}
                <a href="mailto:security@kelp.nyc">security@kelp.nyc</a>
              </Typography>
              <Typography
                variant="h6"
                className={classes.body}
                id="1514f8e0-db44-43b6-a742-7f4b7d99e049"
              >
              ...
              <Typography
                variant="h6"
                className={classes.body}
                id="de721faa-d496-45af-80fa-4e4ce3ae727b"
              >
              ...
              <Typography
                variant="h6"
                className={classes.body}
                id="042e72c2-3eb0-4a15-a597-ce571ac5ef43"
              >
              ...
              <Typography
                variant="h6"
                className={classes.body}
                id="056e16f1-72ac-48be-812b-39b5f11a7a50"
              >
              ...
              <Typography
                variant="h6"
                className={classes.body}
                id="600357df-16ba-46fd-b4e5-6fe855298c5f"
              >
              ...
              <Typography
                variant="h6"
                className={classes.body}
                id="d1611218-4ef7-46b3-81ed-e7f16524fa13"
              >
              ...
              <Typography
                variant="h6"
                className={classes.body}
                id="a45ff7b0-a478-498a-9594-7f17ca94724a"
              >
              ...
              <Typography
                variant="h6"
                className={classes.body}
                id="245f989e-9972-4ff4-b207-d4e295520df4"
              >
              ...
              <Typography
                variant="h6"
                className={classes.body}
                id="63309640-4427-4a27-b83f-87e039c4caaa"
              >
              ...
              <Typography
                variant="h6"
                className={classes.body}
                id="46af72ee-a037-4d27-9b36-d77257a5225a"
              >
              ...
              <Typography
                variant="h6"
                className={classes.body}
                id="5823bba9-df2f-4199-90c3-113955076c2b"
              >
              ...
              <Typography
                variant="h6"
                className={classes.body}
                id="c1fa4772-2575-42ed-ae31-b18536848782"
              >
              ...
              <Typography
                variant="h6"
                className={classes.body}
                id="60849061-52e9-4e86-bed3-85020714d06f"
              >
