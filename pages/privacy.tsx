  ...
  return (
    <div className={clsx(classes.root, classes.container)}>
      <div className={classes.containerWidth}>
        ...
        <ul>
          <li>
            <strong>The right to notice.</strong> You must be properly notified which categories of
          ...
          <li>
            <strong>The right to delete Personal Data.</strong> You also have the right to request
